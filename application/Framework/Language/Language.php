...
class Language extends Singleton {
	...
	public function listAsArray () {
		...
		$languageDir = "application/Resources/languages/";
		$arr = array();
	...
	private static function load ($languageCode) {
		...
		$languageFile = "application/Resources/languages/" . $languageCode . ".php";
		
		// check if file exists
		if (!FileUtilities::exists($languageFile)) {
			return self::load(self::DEFAULT_LANGUAGE);
		}
		
		// load default language
		require("application/Resources/languages/".self::DEFAULT_LANGUAGE.".php");
